...
* **Delays:** Maximum 10 days → -10% per day after deadline.  
...
* The course is active on:  
  **Quera**, **Bale**, **Telegram**, and the **course website**.  
...
<div>
  <div class="imgbox">
    <img src="./assests/AliNajimi.png" alt="Lecturer Photo" width="420">
    <p>Mr. Ali Najimi — Lecturer, Advanced Programming</p>
  </div>
</div>
</div>
